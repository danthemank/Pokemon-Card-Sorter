...
DESCRIPTOR_NPZ_FILE=sys.argv[0]#npz file
DESCRIPTOR_LENGTH_NPZ_FILE=sys.argv[1]#npy file
DATABASE_DICT_FILE=sys.argv[2]#dict json file
DATABASE_FILE = sys.argv[3]#database json file
...
input_file = sys.argv[4]#image got from camera feed
